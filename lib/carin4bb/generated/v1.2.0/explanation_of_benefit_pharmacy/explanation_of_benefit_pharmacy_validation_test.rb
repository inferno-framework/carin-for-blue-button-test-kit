...
module CARINForBlueButton
  module CARIN4BBV120
    class ExplanationOfBenefitPharmacyValidationTest < Inferno::Test
      ...
      id :c4bb_v120_explanation_of_benefit_pharmacy_validation_test
...
fail if their code/system are not found in the valueset.
      ...
      def explanation_of_benefit_pharmacy_resource
        CARIN4BBV120::ExplanationOfBenefitPharmacyReadTest.new().explanation_of_benefit_pharmacy_resource
      end 
