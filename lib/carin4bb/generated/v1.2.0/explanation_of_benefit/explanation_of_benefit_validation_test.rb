...
module CARINForBlueButton
  module CARIN4BBV120
    class ExplanationOfBenefitValidationTest < Inferno::Test
      ...
      id :c4bb_v120_explanation_of_benefit_validation_test
...
fail if their code/system are not found in the valueset.
      ...
      def explanation_of_benefit_resource
        CARIN4BBV120::ExplanationOfBenefitReadTest.new().explanation_of_benefit_resource
      end 

      run do
        perform_validation_test([explanation_of_benefit_resource] || [],
