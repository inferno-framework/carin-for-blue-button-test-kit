...
requirement of US Core v1.2.0.
      ...
      id :c4bb_v120_explanation_of_benefit_professional_non_clinician__id_search_test

      input :c4bb_v120_explanation_of_benefit_professional_non_clinician__id_search_test_param,
...
'
      ...
      run do
        run_search_test(c4bb_v120_explanation_of_benefit_professional_non_clinician__id_search_test_param)
      end
    end
  end
end
