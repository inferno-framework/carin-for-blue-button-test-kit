...
none are returned, the test is skipped.
      ...
      id :c4bb_v120_explanation_of_benefit_professional_non_clinician_type_search_test

      input :c4bb_v120_explanation_of_benefit_professional_non_clinician_type_search_test_param,
...
'
      ...
      run do
        run_search_test(c4bb_v120_explanation_of_benefit_professional_non_clinician_type_search_test_param)
      end
    end
  end
end
