module CarinForBlueButtonTestKit
  class CARIN4BBMustSupportAbsentReasonTest < Inferno::Test
    ...
    description <<~DESCRIPTION
      The Health IT Module behaving as a client must process Must Support elements that assert missing information.
    DESCRIPTION
    ...
    run do
      ...
      wait(
        identifier:,
        message: <<~MESSAGE
          The developer of the Health IT Module attests that the Health IT Module behaving as a client processed
