...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class ExplanationOfBenefitOutpatientInstitutionalExplanationOfBenefit_coverageSearchTest < Inferno::Test
      ...
      run do
        run_include_search('ExplanationOfBenefit:coverage', resource_id: c4bb_v200devnonfinancial_explanation_of_benefit_outpatient_institutional__id_search_test_param)
      end
    end
  end
end
