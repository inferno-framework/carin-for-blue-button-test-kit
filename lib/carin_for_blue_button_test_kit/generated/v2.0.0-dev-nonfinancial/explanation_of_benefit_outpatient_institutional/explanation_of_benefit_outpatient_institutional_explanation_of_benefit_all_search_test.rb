...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:*" as a search parameter 
      ...
      id :c4bb_v200devnonfinancial_explanation_of_benefit_outpatient_institutional_include_ExplanationOfBenefit_All_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:*', include_search: true, resource_id: c4bb_v200devnonfinancial_explanation_of_benefit_outpatient_institutional__id_search_test_param)
      end
    end
  end
end
