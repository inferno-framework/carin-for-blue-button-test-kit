...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobPharmacy_careteamSearchTest < Inferno::Test
...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:care-team" as a search parameter 
      ...
      id :c4bb_v200devnonfinancial_eob_pharmacy_include__careteam_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:care-team', include_search: true, resource_id: c4bb_v200devnonfinancial_eob_pharmacy__id_search_test_param)
      end
    end
  end
end
