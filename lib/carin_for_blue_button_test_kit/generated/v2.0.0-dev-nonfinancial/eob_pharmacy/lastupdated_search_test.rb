...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobPharmacyLastupdatedSearchTest < Inferno::Test
...
none are returned, the test is skipped.
      ...
      id :c4bb_v200devnonfinancial_eob_pharmacy__lastUpdated_search_test

      input :c4bb_v200devnonfinancial_eob_pharmacy__lastUpdated_search_test_param,
      ...
      run do
        ...
        run_search_test(c4bb_v200devnonfinancial_eob_pharmacy__lastUpdated_search_test_param)
      end
    end
  end
end
