require_relative 'eob_pharmacy_non_financial/read_test'
    ...
    require_relative 'eob_pharmacy_non_financial/patient_search_test'
    require_relative 'eob_pharmacy_non_financial/provider_search_test'
    require_relative 'eob_pharmacy_non_financial/careteam_search_test'
    require_relative 'eob_pharmacy_non_financial/coverage_search_test'
    require_relative 'eob_pharmacy_non_financial/insurer_search_test'
    require_relative 'eob_pharmacy_non_financial/payee_search_test'
    require_relative 'eob_pharmacy_non_financial/all_search_test'
...
read succeeds.
          ...
          test from: :c4bb_v200devnonfinancial_eob_pharmacy_non_financial_include__patient_search_test
          test from: :c4bb_v200devnonfinancial_eob_pharmacy_non_financial_include__provider_search_test
          test from: :c4bb_v200devnonfinancial_eob_pharmacy_non_financial_include__careteam_search_test
          test from: :c4bb_v200devnonfinancial_eob_pharmacy_non_financial_include__coverage_search_test
          test from: :c4bb_v200devnonfinancial_eob_pharmacy_non_financial_include__insurer_search_test
          test from: :c4bb_v200devnonfinancial_eob_pharmacy_non_financial_include__payee_search_test
          test from: :c4bb_v200devnonfinancial_eob_pharmacy_non_financial_include__All_search_test
        end
      end
    end
