...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobOutpatientInstitutionalExplanationOfBenefit_AllSearchTest < Inferno::Test
      ...
      id :c4bb_v200devnonfinancial_eob_outpatient_institutional_include_ExplanationOfBenefit_All_search_test
      ...
      run do
        run_include_search('ExplanationOfBenefit:*', resource_id: c4bb_v200devnonfinancial_eob_outpatient_institutional__id_search_test_param)
      end
    end
  end
end
