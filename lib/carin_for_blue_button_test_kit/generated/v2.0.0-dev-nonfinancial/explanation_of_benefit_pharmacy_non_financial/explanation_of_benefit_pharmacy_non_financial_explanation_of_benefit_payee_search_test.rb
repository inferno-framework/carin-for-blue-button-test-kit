...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class ExplanationOfBenefitPharmacyNonFinancialExplanationOfBenefit_payeeSearchTest < Inferno::Test
...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:payee" as a search parameter
      ...
      id :c4bb_v200devnonfinancial_explanation_of_benefit_pharmacy_non_financial_include_ExplanationOfBenefit_payee_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:payee', include_search: true, resource_id: explanation_of_benefit_pharmacy_non_financial_ids_string_formatter)
      end
    end
  end
end
