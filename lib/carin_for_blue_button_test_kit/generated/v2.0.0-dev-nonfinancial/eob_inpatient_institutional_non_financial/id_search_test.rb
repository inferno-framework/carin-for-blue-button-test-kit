...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobInpatientInstitutionalNonFinancialIdSearchTest < Inferno::Test
...
none are returned, the test is skipped.
      ...
      run do
        ...
        run_search_test(c4bb_v200devnonfinancial_eob_inpatient_institutional_non_financial__id_search_test_param)
      end
    end
  end
end
