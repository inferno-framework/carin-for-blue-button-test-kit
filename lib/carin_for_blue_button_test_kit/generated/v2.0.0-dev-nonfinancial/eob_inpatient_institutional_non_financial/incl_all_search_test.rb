...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobInpatientInstitutionalNonFinancialExplanationOfBenefit_AllSearchTest < Inferno::Test
      ...
      id :c4bb_v200devnonfinancial_eob_inpatient_institutional_non_financial_include_ExplanationOfBenefit_All_search_test
      ...
      run do
        run_include_search('ExplanationOfBenefit:*', resource_id: c4bb_v200devnonfinancial_eob_inpatient_institutional_non_financial__id_search_test_param)
      end
    end
  end
end
