...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class ExplanationOfBenefitOutpatientInstitutionalNonFinancialExplanationOfBenefit_providerSearchTest < Inferno::Test
      ...
      run do
        run_include_search('ExplanationOfBenefit:provider', resource_id: c4bb_v200devnonfinancial_explanation_of_benefit_outpatient_institutional_non_financial__id_search_test_param)
      end
    end
  end
end
