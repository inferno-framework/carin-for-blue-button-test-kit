...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobOralNonFinancialPatientSearchTest < Inferno::Test
...
requirement of CARIN IG for Blue Button® v2.0.0-dev-nonfinancial.
      ...
      id :c4bb_v200devnonfinancial_eob_oral_non_financial_patient_search_test

      input :c4bb_v200devnonfinancial_eob_oral_non_financial_patient_search_test_param,
      ...
      run do
        ...
        run_search_test(c4bb_v200devnonfinancial_eob_oral_non_financial_patient_search_test_param)
      end
    end
  end
end
