...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobOralNonFinancialExplanationOfBenefit_coverageSearchTest < Inferno::Test
      ...
      id :c4bb_v200devnonfinancial_eob_oral_non_financial_include_ExplanationOfBenefit_coverage_search_test
      ...
      run do
        run_include_search('ExplanationOfBenefit:coverage', resource_id: c4bb_v200devnonfinancial_eob_oral_non_financial__id_search_test_param)
      end
    end
  end
end
