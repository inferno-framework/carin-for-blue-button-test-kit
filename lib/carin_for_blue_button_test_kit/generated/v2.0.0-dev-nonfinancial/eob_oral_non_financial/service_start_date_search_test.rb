...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobOralNonFinancialServiceStartDateSearchTest < Inferno::Test
...
none are returned, the test is skipped.
      ...
      id :c4bb_v200devnonfinancial_eob_oral_non_financial_service_start_date_search_test

      input :c4bb_v200devnonfinancial_eob_oral_non_financial_service_start_date_search_test_param,
      ...
      run do
        ...
        run_search_test(c4bb_v200devnonfinancial_eob_oral_non_financial_service_start_date_search_test_param)
      end
    end
  end
end
