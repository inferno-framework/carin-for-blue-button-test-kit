...
none are returned, the test is skipped.
      ...
      input :c4bb_v200devnonfinancial_eob_inpatient_institutional_type_search_test_param,
      ...
      run do
        ...
        run_search_test(c4bb_v200devnonfinancial_eob_inpatient_institutional_type_search_test_param)
      end
    end
  end
end
