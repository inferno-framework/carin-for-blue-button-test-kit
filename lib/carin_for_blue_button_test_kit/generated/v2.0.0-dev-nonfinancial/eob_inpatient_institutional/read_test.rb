...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobInpatientInstitutionalReadTest < Inferno::Test
      ...
      id :c4bb_v200devnonfinancial_eob_inpatient_institutional_read_test
      ...
      def resource_ids
        return [] unless respond_to? :additional_eob_inpatient_institutional_ids

        additional_eob_inpatient_institutional_ids.split(',').map(&:strip)
      end
