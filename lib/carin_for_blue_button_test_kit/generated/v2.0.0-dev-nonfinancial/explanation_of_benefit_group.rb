...
require_relative 'explanation_of_benefit_inpatient_institutional_non_financial/explanation_of_benefit_inpatient_institutional_non_financial_validation_test'
require_relative 'explanation_of_benefit_inpatient_institutional_non_financial/explanation_of_benefit_inpatient_institutional_non_financial_must_support_test'
...
require_relative 'explanation_of_benefit_outpatient_institutional_non_financial/explanation_of_benefit_outpatient_institutional_non_financial_validation_test'
require_relative 'explanation_of_benefit_outpatient_institutional_non_financial/explanation_of_benefit_outpatient_institutional_non_financial_must_support_test'
...
require_relative 'explanation_of_benefit_pharmacy_non_financial/explanation_of_benefit_pharmacy_non_financial_validation_test'
require_relative 'explanation_of_benefit_pharmacy_non_financial/explanation_of_benefit_pharmacy_non_financial_must_support_test'
...
read succeeds.
      ...
      id :c4bb_v200devnonfinancial_explanation_of_benefit
      run_as_group
      ...
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_service_date_search_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_service_start_date_search_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_billable_period_start_search_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_include_ExplanationOfBenefit_patient_search_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_include_ExplanationOfBenefit_provider_search_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_include_ExplanationOfBenefit_careteam_search_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_include_ExplanationOfBenefit_coverage_search_test
      ...
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_inpatient_institutional_validation_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_inpatient_institutional_must_support_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_inpatient_institutional_non_financial_validation_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_inpatient_institutional_non_financial_must_support_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_outpatient_institutional_validation_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_outpatient_institutional_must_support_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_outpatient_institutional_non_financial_validation_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_outpatient_institutional_non_financial_must_support_test
      ...
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_pharmacy_validation_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_pharmacy_must_support_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_pharmacy_non_financial_validation_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_pharmacy_non_financial_must_support_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_professional_non_clinician_validation_test
      test from: :c4bb_v200devnonfinancial_explanation_of_benefit_professional_non_clinician_must_support_test
