...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobProfessionalNonClinicianExplanationOfBenefit_payeeSearchTest < Inferno::Test
      ...
      id :c4bb_v200devnonfinancial_eob_professional_non_clinician_include_ExplanationOfBenefit_payee_search_test
      ...
      run do
        run_include_search('ExplanationOfBenefit:payee', resource_id: c4bb_v200devnonfinancial_eob_professional_non_clinician__id_search_test_param)
      end
    end
  end
end
