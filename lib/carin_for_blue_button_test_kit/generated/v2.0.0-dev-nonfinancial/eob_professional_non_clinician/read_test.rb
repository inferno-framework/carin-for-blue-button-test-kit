...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobProfessionalNonClinicianReadTest < Inferno::Test
      ...
      id :c4bb_v200devnonfinancial_eob_professional_non_clinician_read_test
      ...
      def resource_ids
        return [] unless respond_to? :additional_eob_professional_non_clinician_ids

        additional_eob_professional_non_clinician_ids.split(',').map(&:strip)
      end
