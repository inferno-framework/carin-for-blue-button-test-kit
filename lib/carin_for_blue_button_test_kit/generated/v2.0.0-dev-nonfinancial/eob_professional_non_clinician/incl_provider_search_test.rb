...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobProfessionalNonClinicianExplanationOfBenefit_providerSearchTest < Inferno::Test
      ...
      id :c4bb_v200devnonfinancial_eob_professional_non_clinician_include_ExplanationOfBenefit_provider_search_test

      input :c4bb_v200devnonfinancial_eob_professional_non_clinician__id_search_test_param,
      ...
      run do
        run_include_search('ExplanationOfBenefit:provider', resource_id: c4bb_v200devnonfinancial_eob_professional_non_clinician__id_search_test_param)
      end
    end
  end
end
