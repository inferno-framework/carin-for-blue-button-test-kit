...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:coverage" as a search parameter 
      ...
      id :c4bb_v200devnonfinancial_eob_oral_include__coverage_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:coverage', include_search: true, resource_id: c4bb_v200devnonfinancial_eob_oral__id_search_test_param)
      end
    end
  end
end
