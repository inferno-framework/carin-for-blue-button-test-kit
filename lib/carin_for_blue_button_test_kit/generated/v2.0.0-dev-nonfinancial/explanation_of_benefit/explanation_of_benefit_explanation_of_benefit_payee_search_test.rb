...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:payee" as a search parameter 
      ...
      id :c4bb_v200devnonfinancial_explanation_of_benefit_include_ExplanationOfBenefit_payee_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:payee', include_search: true, resource_id: c4bb_v200devnonfinancial_explanation_of_benefit__id_search_test_param)
      end
    end
  end
end
