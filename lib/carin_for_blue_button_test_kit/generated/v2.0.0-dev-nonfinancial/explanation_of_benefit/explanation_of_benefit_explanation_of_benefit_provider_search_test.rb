...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class ExplanationOfBenefitExplanationOfBenefit_providerSearchTest < Inferno::Test
      ...
      id :c4bb_v200devnonfinancial_explanation_of_benefit_include_ExplanationOfBenefit_provider_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:provider', include_search: true, resource_id: c4bb_v200devnonfinancial_explanation_of_benefit__id_search_test_param)
      end
    end
  end
end
