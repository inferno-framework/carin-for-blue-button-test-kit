...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class ExplanationOfBenefitPharmacyExplanationOfBenefit_AllSearchTest < Inferno::Test
      ...
      id :c4bb_v200devnonfinancial_explanation_of_benefit_pharmacy_include_ExplanationOfBenefit_All_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:*', include_search: true, resource_id: c4bb_v200devnonfinancial_explanation_of_benefit_pharmacy__id_search_test_param)
      end
    end
  end
end
