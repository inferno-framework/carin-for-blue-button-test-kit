...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class ExplanationOfBenefitOralNonFinancialIdSearchTest < Inferno::Test
...
requirement of CARIN IG for Blue Button® v2.0.0-dev-nonfinancial.
      ...
      input :explanation_of_benefit_oral_non_financial_ids,
        ...
        type: 'text',
        description: 'Comma separated list of explanation_of_benefit_oral_non_financial IDs that in sum
      ...
      run do
        ...
        run_search_test(explanation_of_benefit_oral_non_financial_ids_string_formatter)
      end
    end
  end
end
