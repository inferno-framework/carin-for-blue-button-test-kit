...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class ExplanationOfBenefitOralNonFinancialExplanationOfBenefit_careteamSearchTest < Inferno::Test
      ...
      id :c4bb_v200devnonfinancial_explanation_of_benefit_oral_non_financial_include_ExplanationOfBenefit_careteam_search_test
      ...
      run do
        run_include_search('ExplanationOfBenefit:care-team', resource_id: c4bb_v200devnonfinancial_explanation_of_benefit_oral_non_financial__id_search_test_param)
      end
    end
  end
end
