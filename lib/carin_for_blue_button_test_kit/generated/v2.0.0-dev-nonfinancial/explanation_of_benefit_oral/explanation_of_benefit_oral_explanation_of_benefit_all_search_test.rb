...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class ExplanationOfBenefitOralExplanationOfBenefit_AllSearchTest < Inferno::Test
...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:*" as a search parameter
      ...
      id :c4bb_v200devnonfinancial_explanation_of_benefit_oral_include_ExplanationOfBenefit_All_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:*', include_search: true, resource_id: explanation_of_benefit_oral_ids_string_formatter)
      end
    end
  end
end
