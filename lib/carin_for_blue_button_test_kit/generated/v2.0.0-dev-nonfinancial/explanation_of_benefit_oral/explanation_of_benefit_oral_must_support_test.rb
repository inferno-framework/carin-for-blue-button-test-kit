...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class ExplanationOfBenefitOralMustSupportTest < Inferno::Test
      ...
      title 'All must support elements are provided in the ExplanationOfBenefitOral resources returned'
      description %(
        ...
        Statement. This test will look through the ExplanationOfBenefitOral resources
      ...
      id :c4bb_v200devnonfinancial_explanation_of_benefit_oral_must_support_test
