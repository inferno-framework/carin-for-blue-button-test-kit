...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class ExplanationOfBenefitInpatientInstitutionalNonFinancialExplanationOfBenefit_patientSearchTest < Inferno::Test
      ...
      run do
        run_include_search('ExplanationOfBenefit:patient', resource_id: c4bb_v200devnonfinancial_explanation_of_benefit_inpatient_institutional_non_financial__id_search_test_param)
      end
    end
  end
end
