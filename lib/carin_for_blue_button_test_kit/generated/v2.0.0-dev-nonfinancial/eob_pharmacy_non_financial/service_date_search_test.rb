...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobPharmacyNonFinancialServiceDateSearchTest < Inferno::Test
...
none are returned, the test is skipped.
      ...
      input :c4bb_v200devnonfinancial_eob_pharmacy_non_financial_service_date_search_test_param,
      ...
      run do
        ...
        run_search_test(c4bb_v200devnonfinancial_eob_pharmacy_non_financial_service_date_search_test_param)
      end
    end
  end
end
