...
module CarinForBlueButtonTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobPharmacyNonFinancial_AllSearchTest < Inferno::Test
...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:*" as a search parameter 
      ...
      id :c4bb_v200devnonfinancial_eob_pharmacy_non_financial_include__All_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:*', include_search: true, resource_id: c4bb_v200devnonfinancial_eob_pharmacy_non_financial__id_search_test_param)
      end
    end
  end
end
