...
module CarinForBlueButtonTestKit
  module CARIN4BBV200
    class EobOutpatientInstitutional_coverageSearchTest < Inferno::Test
...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:coverage" as a search parameter 
      ...
      id :c4bb_v200_eob_outpatient_institutional_include__coverage_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:coverage', include_search: true, resource_id: c4bb_v200_eob_outpatient_institutional__id_search_test_param)
      end
    end
  end
end
