...
read succeeds.
      ...
      test from: :c4bb_v200_eob_patient_search_test
      test from: :c4bb_v200_eob__id_search_test
      test from: :c4bb_v200_eob__lastUpdated_search_test
      test from: :c4bb_v200_eob_type_search_test
      test from: :c4bb_v200_eob_identifier_search_test
      test from: :c4bb_v200_eob_service_date_search_test
      test from: :c4bb_v200_eob_service_start_date_search_test
      test from: :c4bb_v200_eob_billable_period_start_search_test
      test from: :c4bb_v200_eob_include_ExplanationOfBenefit_patient_search_test
      test from: :c4bb_v200_eob_include_ExplanationOfBenefit_provider_search_test
      test from: :c4bb_v200_eob_include_ExplanationOfBenefit_careteam_search_test
      test from: :c4bb_v200_eob_include_ExplanationOfBenefit_coverage_search_test
      test from: :c4bb_v200_eob_include_ExplanationOfBenefit_insurer_search_test
      test from: :c4bb_v200_eob_include_ExplanationOfBenefit_payee_search_test
      test from: :c4bb_v200_eob_include_ExplanationOfBenefit_All_search_test
      test from: :c4bb_v200_eob_read_test
      test from: :c4bb_v200_eob_validation_test
      test from: :c4bb_v200_eob_must_support_test
