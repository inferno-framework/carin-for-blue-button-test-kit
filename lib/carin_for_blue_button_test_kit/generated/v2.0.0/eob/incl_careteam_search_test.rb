...
module CarinForBlueButtonTestKit
  module CARIN4BBV200
    class EobExplanationOfBenefit_careteamSearchTest < Inferno::Test
      ...
      id :c4bb_v200_eob_include_ExplanationOfBenefit_careteam_search_test

      input :c4bb_v200_eob__id_search_test_param,
      ...
      run do
        run_include_search('ExplanationOfBenefit:care-team', resource_id: c4bb_v200_eob__id_search_test_param)
      end
    end
  end
end
