...
module CarinForBlueButtonTestKit
  module CARIN4BBV200
    class ExplanationOfBenefitProfessionalNonClinicianExplanationOfBenefit_coverageSearchTest < Inferno::Test
      ...
      id :c4bb_v200_explanation_of_benefit_professional_non_clinician_include_ExplanationOfBenefit_coverage_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:coverage', include_search: true, resource_id: c4bb_v200_explanation_of_benefit_professional_non_clinician__id_search_test_param)
      end
    end
  end
end
