...
require_relative 'eob_pharmacy/incl_payee_search_test'
...
read succeeds.
      ...
      test from: :c4bb_v200_eob_pharmacy_patient_search_test
      test from: :c4bb_v200_eob_pharmacy__id_search_test
      test from: :c4bb_v200_eob_pharmacy__lastUpdated_search_test
      test from: :c4bb_v200_eob_pharmacy_type_search_test
      test from: :c4bb_v200_eob_pharmacy_identifier_search_test
      test from: :c4bb_v200_eob_pharmacy_service_date_search_test
      test from: :c4bb_v200_eob_pharmacy_service_start_date_search_test
      test from: :c4bb_v200_eob_pharmacy_billable_period_start_search_test
      test from: :c4bb_v200_eob_pharmacy_include_ExplanationOfBenefit_patient_search_test
      test from: :c4bb_v200_eob_pharmacy_include_ExplanationOfBenefit_provider_search_test
      test from: :c4bb_v200_eob_pharmacy_include_ExplanationOfBenefit_careteam_search_test
      test from: :c4bb_v200_eob_pharmacy_include_ExplanationOfBenefit_coverage_search_test
      test from: :c4bb_v200_eob_pharmacy_include_ExplanationOfBenefit_insurer_search_test
      test from: :c4bb_v200_eob_pharmacy_include_ExplanationOfBenefit_payee_search_test
      test from: :c4bb_v200_eob_pharmacy_include_ExplanationOfBenefit_All_search_test
      test from: :c4bb_v200_eob_pharmacy_read_test
      test from: :c4bb_v200_eob_pharmacy_validation_test
