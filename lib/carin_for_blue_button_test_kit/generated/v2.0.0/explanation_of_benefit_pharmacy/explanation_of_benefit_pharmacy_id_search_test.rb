...
requirement of CARIN IG for Blue Button® v2.0.0.
      ...
      input :explanation_of_benefit_pharmacy_ids,
        ...
        type: 'text',
        description: 'Comma separated list of explanation_of_benefit_pharmacy IDs that in sum
      ...
      run do
        ...
        run_search_test(explanation_of_benefit_pharmacy_ids_string_formatter)
      end
    end
  end
end
