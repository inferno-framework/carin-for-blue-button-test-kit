...
module CarinForBlueButtonTestKit
  module CARIN4BBV200
    class ExplanationOfBenefitInpatientInstitutionalExplanationOfBenefit_payeeSearchTest < Inferno::Test
      ...
      run do
        run_search_test('ExplanationOfBenefit:payee', include_search: true, resource_id: c4bb_v200_explanation_of_benefit_inpatient_institutional__id_search_test_param)
      end
    end
  end
end
