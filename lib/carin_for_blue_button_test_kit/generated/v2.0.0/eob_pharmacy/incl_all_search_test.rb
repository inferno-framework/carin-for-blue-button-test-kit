...
module CarinForBlueButtonTestKit
  module CARIN4BBV200
    class EobPharmacyExplanationOfBenefit_AllSearchTest < Inferno::Test
      ...
      id :c4bb_v200_eob_pharmacy_include_ExplanationOfBenefit_All_search_test
      ...
      run do
        run_include_search('ExplanationOfBenefit:*', resource_id: c4bb_v200_eob_pharmacy__id_search_test_param)
      end
    end
  end
end
