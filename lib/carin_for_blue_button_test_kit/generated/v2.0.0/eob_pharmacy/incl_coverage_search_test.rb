...
module CarinForBlueButtonTestKit
  module CARIN4BBV200
    class EobPharmacyExplanationOfBenefit_coverageSearchTest < Inferno::Test
      ...
      id :c4bb_v200_eob_pharmacy_include_ExplanationOfBenefit_coverage_search_test
      ...
      run do
        run_include_search('ExplanationOfBenefit:coverage', resource_id: c4bb_v200_eob_pharmacy__id_search_test_param)
      end
    end
  end
end
