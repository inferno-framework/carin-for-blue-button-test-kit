...
requirement of CARIN IG for Blue Button® v2.0.0.
      ...
      id :c4bb_v200_eob_pharmacy_patient_search_test

      input :c4bb_v200_eob_pharmacy_patient_search_test_param,
      ...
      run do
        ...
        run_search_test(c4bb_v200_eob_pharmacy_patient_search_test_param)
      end
    end
  end
end
