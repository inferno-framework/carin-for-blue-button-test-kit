...
module CarinForBlueButtonTestKit
  module CARIN4BBV200
    class EobInpatientInstitutionalExplanationOfBenefit_providerSearchTest < Inferno::Test
      ...
      id :c4bb_v200_eob_inpatient_institutional_include_ExplanationOfBenefit_provider_search_test
      ...
      run do
        run_include_search('ExplanationOfBenefit:provider', resource_id: c4bb_v200_eob_inpatient_institutional__id_search_test_param)
      end
    end
  end
end
