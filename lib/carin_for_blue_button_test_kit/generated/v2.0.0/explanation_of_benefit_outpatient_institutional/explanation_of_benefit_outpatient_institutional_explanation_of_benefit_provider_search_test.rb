...
module CarinForBlueButtonTestKit
  module CARIN4BBV200
    class ExplanationOfBenefitOutpatientInstitutionalExplanationOfBenefit_providerSearchTest < Inferno::Test
      ...
      run do
        run_search_test('ExplanationOfBenefit:provider', include_search: true, resource_id: c4bb_v200_explanation_of_benefit_outpatient_institutional__id_search_test_param)
      end
    end
  end
end
