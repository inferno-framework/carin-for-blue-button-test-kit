...
module CarinForBlueButtonTestKit
  module CARIN4BBV110
    class ExplanationOfBenefitInpatientInstitutionalExplanationOfBenefit_AllSearchTest < Inferno::Test
      ...
      id :c4bb_v110_explanation_of_benefit_inpatient_institutional_include_ExplanationOfBenefit_All_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:*', include_search: true, resource_id: c4bb_v110_explanation_of_benefit_inpatient_institutional__id_search_test_param)
      end
    end
  end
end
