...
module CarinForBlueButtonTestKit
  module CARIN4BBV110
    class ExplanationOfBenefitInpatientInstitutionalExplanationOfBenefit_patientSearchTest < Inferno::Test
      ...
      run do
        run_search_test('ExplanationOfBenefit:patient', include_search: true, resource_id: c4bb_v110_explanation_of_benefit_inpatient_institutional__id_search_test_param)
      end
    end
  end
end
