...
read succeeds.
          ...
          test from: :c4bb_v110_eob_outpatient_institutional_include__patient_search_test
          test from: :c4bb_v110_eob_outpatient_institutional_include__provider_search_test
          test from: :c4bb_v110_eob_outpatient_institutional_include__careteam_search_test
          test from: :c4bb_v110_eob_outpatient_institutional_include__coverage_search_test
          test from: :c4bb_v110_eob_outpatient_institutional_include__insurer_search_test
          test from: :c4bb_v110_eob_outpatient_institutional_include__All_search_test
        end
      end
    end
