...
none are returned, the test is skipped.
      ...
      id :c4bb_v110_eob_outpatient_institutional_identifier_search_test

      input :c4bb_v110_eob_outpatient_institutional_identifier_search_test_param,
      ...
      run do
        ...
        run_search_test(c4bb_v110_eob_outpatient_institutional_identifier_search_test_param)
      end
    end
  end
end
