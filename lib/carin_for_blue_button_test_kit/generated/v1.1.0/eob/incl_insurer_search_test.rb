...
module CarinForBlueButtonTestKit
  module CARIN4BBV110
    class EobExplanationOfBenefit_insurerSearchTest < Inferno::Test
      ...
      id :c4bb_v110_eob_include_ExplanationOfBenefit_insurer_search_test
      ...
      run do
        run_include_search('ExplanationOfBenefit:insurer', resource_id: c4bb_v110_eob__id_search_test_param)
      end
    end
  end
end
