...
module CarinForBlueButtonTestKit
  module CARIN4BBV110
    class ExplanationOfBenefitProfessionalNonClinicianExplanationOfBenefit_insurerSearchTest < Inferno::Test
      ...
      run do
        run_search_test('ExplanationOfBenefit:insurer', include_search: true, resource_id: c4bb_v110_explanation_of_benefit_professional_non_clinician__id_search_test_param)
      end
    end
  end
end
