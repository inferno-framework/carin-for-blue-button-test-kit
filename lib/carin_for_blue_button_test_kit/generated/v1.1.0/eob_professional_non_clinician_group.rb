...
read succeeds.
      ...
      id :c4bb_v110_eob_professional_non_clinician
      run_as_group
      ...
      test from: :c4bb_v110_eob_professional_non_clinician_patient_search_test
      test from: :c4bb_v110_eob_professional_non_clinician__id_search_test
      test from: :c4bb_v110_eob_professional_non_clinician__lastUpdated_search_test
      test from: :c4bb_v110_eob_professional_non_clinician_type_search_test
      test from: :c4bb_v110_eob_professional_non_clinician_identifier_search_test
      test from: :c4bb_v110_eob_professional_non_clinician_service_date_search_test
      test from: :c4bb_v110_eob_professional_non_clinician_include_ExplanationOfBenefit_patient_search_test
      test from: :c4bb_v110_eob_professional_non_clinician_include_ExplanationOfBenefit_provider_search_test
      test from: :c4bb_v110_eob_professional_non_clinician_include_ExplanationOfBenefit_careteam_search_test
      test from: :c4bb_v110_eob_professional_non_clinician_include_ExplanationOfBenefit_coverage_search_test
      test from: :c4bb_v110_eob_professional_non_clinician_include_ExplanationOfBenefit_insurer_search_test
      test from: :c4bb_v110_eob_professional_non_clinician_include_ExplanationOfBenefit_All_search_test
      test from: :c4bb_v110_eob_professional_non_clinician_read_test
