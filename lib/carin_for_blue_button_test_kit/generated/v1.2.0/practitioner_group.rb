...
read succeeds.
          ...
          test from: :c4bb_v120_practitioner_read_test
          test from: :c4bb_v120_practitioner_validation_test
          test from: :c4bb_v120_practitioner_must_support_test
        end
      end
    end
