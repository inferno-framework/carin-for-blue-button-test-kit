...
read succeeds.
          ...
          id :c4bb_v120_explanation_of_benefit
          run_as_group
          ...
          test from: :c4bb_v120_explanation_of_benefit_read_test
          test from: :c4bb_v120_explanation_of_benefit_validation_test
          test from: :c4bb_v120_explanation_of_benefit_must_support_test
          test from: :c4bb_v120_explanation_of_benefit__id_search_test
          test from: :c4bb_v120_explanation_of_benefit_patient_search_test
          test from: :c4bb_v120_explanation_of_benefit__lastUpdated_search_test
          test from: :c4bb_v120_explanation_of_benefit_type_search_test
          test from: :c4bb_v120_explanation_of_benefit_identifier_search_test
          test from: :c4bb_v120_explanation_of_benefit_service_date_search_test
          test from: :c4bb_v120_explanation_of_benefit_service_start_date_search_test
          test from: :c4bb_v120_explanation_of_benefit_include_ExplanationOfBenefit_patient_search_test
          test from: :c4bb_v120_explanation_of_benefit_include_ExplanationOfBenefit_provider_search_test
          test from: :c4bb_v120_explanation_of_benefit_include_ExplanationOfBenefit_careteam_search_test
          test from: :c4bb_v120_explanation_of_benefit_include_ExplanationOfBenefit_coverage_search_test
          test from: :c4bb_v120_explanation_of_benefit_include_ExplanationOfBenefit_insurer_search_test
          test from: :c4bb_v120_explanation_of_benefit_include_ExplanationOfBenefit_All_search_test
        end
      end
    end
