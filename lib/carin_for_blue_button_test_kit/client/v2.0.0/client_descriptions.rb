...
module CarinForBlueButtonTestKit
  ...
  INPUT_JWK_SET_LOCKED =
    'If this session has been configured for SMART App Lanch access using confidential asymmetric ' \
    'authentication, this input contains either a publicly accessible url pointing to the JSON Web Key ' \
    'Set (JWKS), or the raw JWKS. Run the **1** Client Registration group to configure this session for ' \
    'SMART-based access.'
end
