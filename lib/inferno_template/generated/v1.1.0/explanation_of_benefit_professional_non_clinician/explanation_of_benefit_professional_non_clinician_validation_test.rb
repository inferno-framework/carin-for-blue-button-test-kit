...
fail if their code/system are not found in the valueset.
      ...
      def explanation_of_benefit_professional_non_clinician_resource
        CARIN4BBV110::ExplanationOfBenefitProfessionalNonClinicianReadTest.new().explanation_of_benefit_professional_non_clinician_resource
      end 

      run do
        perform_validation_test([explanation_of_benefit_professional_non_clinician_resource] || [],
