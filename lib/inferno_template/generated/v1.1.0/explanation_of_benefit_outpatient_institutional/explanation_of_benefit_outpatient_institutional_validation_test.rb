...
module InfernoTemplate
  module CARIN4BBV110
    class ExplanationOfBenefitOutpatientInstitutionalValidationTest < Inferno::Test
      include InfernoTemplate::ValidationTest
      include InfernoTemplate::CARIN4BBV110

      id :c4bb_v110_explanation_of_benefit_outpatient_institutional_validation_test
...
fail if their code/system are not found in the valueset.
      ...
      def explanation_of_benefit_outpatient_institutional_resource
        CARIN4BBV110::ExplanationOfBenefitOutpatientInstitutionalReadTest.new().explanation_of_benefit_outpatient_institutional_resource
      end 

      run do
        perform_validation_test([explanation_of_benefit_outpatient_institutional_resource] || [],
