...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:insurer" as a search parameter 
      ...
      id :c4bb_v110_eob_professional_non_clinician_include_ExplanationOfBenefit_insurer_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:insurer', include_search: true, resource_id: c4bb_v110_eob_professional_non_clinician__id_search_test_param)
      end
    end
  end
end
