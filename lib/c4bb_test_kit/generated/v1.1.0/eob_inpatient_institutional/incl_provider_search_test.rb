...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:provider" as a search parameter 
      ...
      id :c4bb_v110_eob_inpatient_institutional_include_ExplanationOfBenefit_provider_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:provider', include_search: true, resource_id: c4bb_v110_eob_inpatient_institutional__id_search_test_param)
      end
    end
  end
end
