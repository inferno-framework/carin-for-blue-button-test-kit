...
module CarinForBlueButtonTestKit
  module CARIN4BBV200
    class EobOralExplanationOfBenefit_providerSearchTest < Inferno::Test
...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:provider" as a search parameter 
      ...
      id :c4bb_v200_eob_oral_include_ExplanationOfBenefit_provider_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:provider', include_search: true, resource_id: c4bb_v200_eob_oral__id_search_test_param)
      end
    end
  end
end
