...
module C4BBTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobExplanationOfBenefit_careteamSearchTest < Inferno::Test
...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:care-team" as a search parameter 
      ...
      id :c4bb_v200devnonfinancial_eob_include_ExplanationOfBenefit_careteam_search_test

      input :c4bb_v200devnonfinancial_eob__id_search_test_param,
      ...
      run do
        run_search_test('ExplanationOfBenefit:care-team', include_search: true, resource_id: c4bb_v200devnonfinancial_eob__id_search_test_param)
      end
    end
  end
end
