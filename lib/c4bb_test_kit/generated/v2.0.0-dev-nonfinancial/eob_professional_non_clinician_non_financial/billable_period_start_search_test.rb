...
module C4BBTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobProfessionalNonClinicianNonFinancialBillablePeriodStartSearchTest < Inferno::Test
...
none are returned, the test is skipped.
      ...
      id :c4bb_v200devnonfinancial_eob_professional_non_clinician_non_financial_billable_period_start_search_test

      input :c4bb_v200devnonfinancial_eob_professional_non_clinician_non_financial_billable_period_start_search_test_param,
...
'
      ...
      run do
        ...
        run_search_test(c4bb_v200devnonfinancial_eob_professional_non_clinician_non_financial_billable_period_start_search_test_param)
      end
    end
  end
end
