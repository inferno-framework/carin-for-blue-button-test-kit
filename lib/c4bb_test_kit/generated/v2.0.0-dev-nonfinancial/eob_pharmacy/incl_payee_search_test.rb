...
module C4BBTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobPharmacyExplanationOfBenefit_payeeSearchTest < Inferno::Test
...
Tests that the server responds correctly when using _include="ExplanationOfBenefit:payee" as a search parameter 
      ...
      id :c4bb_v200devnonfinancial_eob_pharmacy_include_ExplanationOfBenefit_payee_search_test
      ...
      run do
        run_search_test('ExplanationOfBenefit:payee', include_search: true, resource_id: c4bb_v200devnonfinancial_eob_pharmacy__id_search_test_param)
      end
    end
  end
end
