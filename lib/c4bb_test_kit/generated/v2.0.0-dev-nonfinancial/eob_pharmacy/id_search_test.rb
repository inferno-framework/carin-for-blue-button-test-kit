...
module C4BBTestKit
  module CARIN4BBV200DEVNONFINANCIAL
    class EobPharmacyIdSearchTest < Inferno::Test
...
requirement of CARIN IG for Blue Button® v2.0.0-dev-nonfinancial.
      ...
      id :c4bb_v200devnonfinancial_eob_pharmacy__id_search_test
...
'
      ...
      run do
        ...
        run_search_test(c4bb_v200devnonfinancial_eob_pharmacy__id_search_test_param)
      end
    end
  end
end
